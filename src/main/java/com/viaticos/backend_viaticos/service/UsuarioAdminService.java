...
public class UsuarioAdminService {
        ...
        private void registrarAuditoria(String accion, String tabla, Long idRegistro, String valorAnterior,
                ...
                try {
                        String correoEjecutor = org.springframework.security.core.context.SecurityContextHolder
                                        .getContext()
        ...
        public UsuarioCreadoResponseDTO crearUsuarioConEmpleado(CreateUserRequestDTO dto) {
                ...
                registrarAuditoria(
                                ...
                                null,
                                null,
                                "Creó nueva cuenta para: " + empleadoGuardado.getNombre() + " "
        ...
        public UsuarioAdminDTO cambiarEstado(Long idUsuario) {
                ...
                registrarAuditoria(
                                user.getEstado().equals("ACTIVO") ? "EDICIÓN" : "ELIMINACIÓN", // Si lo inactiva, lo
                                                                                               // marcamos como
                                                                                               // eliminación lógica
                                "USUARIO",
                                user.getIdUsuario(),
